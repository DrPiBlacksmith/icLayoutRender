...
\fancyfoot[L]{\parbox[t]{0.98\headwidth}{\footnotesize{\sffamily JoÃƒÂ£o R. R. O Martins and Pietro M. Ferreira,, (2021). IC-Layout
...
layout in Python}
        ...
        \author[1, 2]{JoÃƒÂ£o R. R. O. Martins}
         \author[1, 2]{Pietro M. Ferreira}
    
      \affil[1]{UniversitÃƒÂ© Paris-Saclay, CentraleSupÃƒÂ©lec, CNRS, Lab. de
GÃƒÂ©nie Ãƒâ€°lectrique et Ãƒâ€°lectronique de Paris,91192,Gif-sur-Yvette,France}

      \affil[2]{Sorbonne UniversitÃƒÂ©, CNRS, Lab. de GÃƒÂ©nie Ãƒâ€°lectrique et
Ãƒâ€°lectronique de Paris, 75252, Paris, France}
  \date{\vspace{-7ex}}
...
\begin{figure}[ht]
\begin{center}
\includegraphicsx{./VCO_color.pdf}
