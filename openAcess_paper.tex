...
\fancyfoot[L]{\parbox[t]{0.98\headwidth}{\footnotesize{\sffamily JoÃ£o R. R. O Martins and Pietro M. Ferreira,, (2021). IC-Layout
...
layout in Python}
        ...
        \author[1, 2]{JoÃ£o R. R. O. Martins}
         \author[1, 2]{Pietro M. Ferreira}
    
      \affil[1]{UniversitÃ© Paris-Saclay, CentraleSupÃ©lec, CNRS, Lab. de
GÃ©nie Ã‰lectrique et Ã‰lectronique de Paris,91192,Gif-sur-Yvette,France}

      \affil[2]{Sorbonne UniversitÃ©, CNRS, Lab. de GÃ©nie Ã‰lectrique et
Ã‰lectronique de Paris, 75252, Paris, France}
  \date{\vspace{-7ex}}
